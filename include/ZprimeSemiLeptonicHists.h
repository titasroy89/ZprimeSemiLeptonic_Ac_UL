...
protected:
  ...
  // TH1F *topgen_pt, *topgen_eta, *antitopgen_pt, *antitopgen_eta, *leptongen_pt, *leptongen_eta, *muongen_pt, *muongen_eta, *electrongen_pt, *electrongen_eta, *bquarkgen_pt, *bquarkgen_eta;
