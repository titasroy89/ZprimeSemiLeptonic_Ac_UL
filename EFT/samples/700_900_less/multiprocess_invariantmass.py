    ...
    for ientry in range(nentries_in_file):
        ...
        for top in top_quarks:
            ...
            if b_quark and w_boson:
                ...
                # To focu on hadronic decays to get quarks (for number jet plot):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_file', default='mttbar_multiprocess_700_900less.root', help='Output ROOT file name')
    ...
    canvas_njets.SaveAs("number_of_jets_700_900less.png")
    ...
    canvas_mttbar.SaveAs("mttbar_reconstructed_700_900less.png")

    print("\nProcessing complete. Histogram saved as 'number_of_jets.png' and '{}'.".format(output_file_name))
