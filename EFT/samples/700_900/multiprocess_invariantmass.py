...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_file', default='mttbar_multiprocess_700_900.root', help='Output ROOT file name')
    ...
    canvas_njets.SaveAs("number_of_jets_700_900.png")
    ...
    canvas_mttbar.SaveAs("mttbar_reconstructed_700_900.png")
