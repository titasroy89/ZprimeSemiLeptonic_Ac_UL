...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_file', default='mttbar_multiprocess_0_700_1.root', help='Output ROOT file name')
    ...
    canvas_njets.SaveAs("number_of_jets_0_700_1.png")
    ...
    canvas_mttbar.SaveAs("mttbar_reconstructed_0_700_1.png")
