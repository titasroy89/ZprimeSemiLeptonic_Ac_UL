...
def plot_leadingLeptonPt_with_combined():
    ...
    hist_name = "LHEMttbarAnalyzer/leadingLeptonPt"
    ...
    # hist_combined.SetLineColor(ROOT.kBlack)  # Distinct color for combined histogram
    ...
    # **Create Canvas**
    c1 = ROOT.TCanvas("c1", "leadingLeptonPt Distribution", 800, 600)
    c1.SetGrid()

    # **Set Axis Titles**
    hist1.GetXaxis().SetTitle("Lepton Pt [GeV]")
    if normalize:
    ...
    # hist_combined.Draw("HIST SAME")  # Draw combined histogram
...
if __name__ == "__main__":
    plot_leadingLeptonPt_with_combined()
