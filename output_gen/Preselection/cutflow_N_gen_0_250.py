...
dirs = ["Gen_N_General", "Ele_gen_N_0_250_General","Ele_N_Pt_0_250_General", "Ele_N_Pt_Eta_0_250_General", "Ele_N_JetPt_0_250_General", "Ele_N_JetPt_Eta_0_250_General"]
...
print("UL18 electron -> Number of events with 0-250 mass cut: {}".format(hist2.Integral()))
...
cutflow = ROOT.TH1F("cutflow", "UL18 Ele DeltaY < 0, 0<Mtt<250", 6, 0, 6)
...
canvas = ROOT.TCanvas("canvas", "UL18_gen electron DeltaY < 0, 0<Mtt<250", 800, 600)
cutflow.Draw()

canvas.Draw()
canvas.SaveAs("DeltaY_N_gen_ele_0_250.png")
