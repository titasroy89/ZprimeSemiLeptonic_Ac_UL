...
dirs = ["Gen_N_General", "Ele_gen_N_500_750_General","Ele_N_Pt_500_750_General", "Ele_N_Pt_Eta_500_750_General", "Ele_N_JetPt_500_750_General", "Ele_N_JetPt_Eta_500_750_General"]
...
print("UL18 Electron -> Number of events with 500-750 mass cut: {}".format(hist2.Integral()))
...
cutflow = ROOT.TH1F("cutflow", "UL18 Ele DeltaY < 0, 500<Mtt<750", 6, 0, 6)
...
canvas = ROOT.TCanvas("canvas", "UL18 Ele DeltaY < 0, 500<Mtt<750", 800, 600)
cutflow.Draw()

canvas.Draw()
canvas.SaveAs("DeltaY_N_gen_ele_500_750.png")
