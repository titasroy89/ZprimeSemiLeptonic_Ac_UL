...
dirs = ["Gen_N_General", "Ele_gen_N_750_900_General","Ele_N_Pt_750_900_General", "Ele_N_Pt_Eta_750_900_General", "Ele_N_JetPt_750_900_General", "Ele_N_JetPt_Eta_750_900_General"]
...
print("UL18 Electron -> Number of events with 750-900 mass cut: {}".format(hist2.Integral()))
...
cutflow = ROOT.TH1F("cutflow", "UL18 Ele DeltaY < 0, 750<Mtt<900", 6, 0, 6)
...
canvas = ROOT.TCanvas("canvas", "UL18 Ele DeltaY < 0, 750<Mtt<900", 800, 600)
cutflow.Draw()

canvas.Draw()
canvas.SaveAs("DeltaY_N_gen_ele_750_900.png")
