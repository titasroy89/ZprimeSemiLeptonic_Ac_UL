...
dirs = ["Gen_N_General", "Ele_gen_N_250_500_General","Ele_N_Pt_250_500_General", "Ele_N_Pt_Eta_250_500_General", "Ele_N_JetPt_250_500_General", "Ele_N_JetPt_Eta_250_500_General"]
...
print("UL18 Electron -> Number of events with 250-500 mass cut: {}".format(hist2.Integral()))
...
cutflow = ROOT.TH1F("cutflow", "UL18 Ele DeltaY < 0, 250<Mtt<500", 6, 0, 6)
...
canvas = ROOT.TCanvas("canvas", "UL18 Ele DeltaY < 0, 250<Mtt<500", 800, 600)
cutflow.Draw()

canvas.Draw()
canvas.SaveAs("DeltaY_N_gen_ele_250_500.png")
