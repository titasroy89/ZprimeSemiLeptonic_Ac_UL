...
hist5 = ROOT.TH1F("hist4", "DeltaY_N_gen_jet_eta_muon", 1, -2, 2)
...
print("UL16postVFP muon -> Number of events with lepton_pt eta & jet pt cut : {}".format(hist4.Integral()))
print("UL16postVFP muon -> Number of events with lepton_pt eta & jet pt eta cut : {}".format(hist5.Integral()))

        
# Create a new histogram with 3 bins
cutflow = ROOT.TH1F("cutflow", "UL16postVFP muon DeltaY < 0", 4, 0, 4)
