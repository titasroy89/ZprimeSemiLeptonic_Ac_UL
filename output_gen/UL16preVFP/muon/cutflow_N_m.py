...
print("UL16preVFP muon -> Number of events with lepton_pt eta & jet pt cut : {}".format(hist4.Integral()))
print("UL16preVFP muon -> Number of events with lepton_pt eta & jet pt eta cut : {}".format(hist5.Integral()))

        
# Create a new histogram with 3 bins
cutflow = ROOT.TH1F("cutflow", "UL16preVFP muon DeltaY < 0", 4, 0, 4)
