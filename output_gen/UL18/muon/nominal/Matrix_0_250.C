...
void Matrix_0_250() {
    ...
    std::map<std::string, std::string> histNames = {
        {"DY_N_N_Mass_0_250_reco_muon_General/DeltaY_muon", "h_DeltaY_N_N"}, 
        {"DY_N_P_Mass_0_250_reco_muon_General/DeltaY_muon", "h_DeltaY_N_P"}, 
        {"DY_P_N_Mass_0_250_reco_muon_General/DeltaY_muon", "h_DeltaY_P_N"}, 
        {"DY_P_P_Mass_0_250_reco_muon_General/DeltaY_muon", "h_DeltaY_P_P"}
        };
