...
void Matrix_250_500() {
    ...
    std::map<std::string, std::string> histNames = {
        {"DY_N_N_Mass_250_500_reco_muon_General/DeltaY_reco", "h_DeltaY_N_N"}, 
        {"DY_N_P_Mass_250_500_reco_muon_General/DeltaY_reco", "h_DeltaY_N_P"}, 
        {"DY_P_N_Mass_250_500_reco_muon_General/DeltaY_reco", "h_DeltaY_P_N"}, 
        {"DY_P_P_Mass_250_500_reco_muon_General/DeltaY_reco", "h_DeltaY_P_P"}
        };


    TH2D* Matrix = new TH2D("250 < Mtt  <500", "250 < Mtt  <500", 2, -2.5, 2.5, 2, -2.5,2.5);
    Matrix->GetXaxis()->SetTitle("#Delta |Y_{rec}|");
    Matrix->GetYaxis()->SetTitle("#Delta |Y_{gen}|");


    TFile* outFile = new TFile("250_500.root", "RECREATE");
    ...
    TFile* openOutFile = new TFile("250_500.root", "READ");
    ...
    TFile* outFileWrite = new TFile("250_500.root", "UPDATE");
    outFileWrite->cd();  
    Matrix->Write();
    outFileWrite->Close();
