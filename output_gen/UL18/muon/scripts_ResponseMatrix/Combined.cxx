...
void Combined() {
    ...
    TH2F* Matrix_Combined = new TH2F("Matrix_Combined", "Matrix_Combined", 10, 0, 10, 10, 0, 10);
    ...
    for (int i = 0; i < 5; ++i) {
        xAxis->SetBinLabel(2*i + 1, matrixNames[i].c_str());
        yAxis->SetBinLabel(2*i + 1, matrixNames[i].c_str());
    }

    TFile* outFile = new TFile("CombinedMatrix2.root", "RECREATE");
