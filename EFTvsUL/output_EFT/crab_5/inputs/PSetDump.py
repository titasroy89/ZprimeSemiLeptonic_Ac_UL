...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/user/beozek/try-2/MiniAOD_1.root'),
...
process.electronMVATOP = cms.EDProducer("EleBaseMVAValueMapProducer",
    ...
    weightFile = cms.FileInPath('UHH2/common/data/UL18/TMVA_BDTG_TOP_elec_2018.weights.xml')
)
...
process.muonMVATOP = cms.EDProducer("MuonBaseMVAValueMapProducer",
    ...
    weightFile = cms.FileInPath('UHH2/common/data/UL18/TMVA_BDTG_TOP_muon_2018.weights.xml')
)
