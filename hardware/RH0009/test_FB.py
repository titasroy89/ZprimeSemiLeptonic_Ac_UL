...
parser.add_argument('-outpath','--outpath', help = 'The name of the folder to be created in results', default = 'RH0027_3000e_Chip13_10_2', type = str)
parser.add_argument('-sensor','--sensor', help = 'The name of the sensor', default = 'RH0027_Chip13', type = str)
parser.add_argument('-thr_missing','--thr_missing', help = 'The threshold to classify the missing bumps [DVCAL]', default = 20, type = int)
...
parser.add_argument('-noise_missing','--noise_missing', help = 'The noise threshold to classify the missing bumps [DVCAL]', default = 2, type = int)
...
thr_data_file1='./Run000001_SCurve.root'
thr_data_file2='./Run000002_SCurve.root'
Path='completetune_3500/'+args.outpath+'/'
