...
Sensor=args.sensor; 
thr_data_file='/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/hardware/SH0015/lowOcc/Run000031_SCurve.root'
# Path where the results will be stored
Path='results_xray/'
# Path to the NoiseScan root file (PixelAlive for us)
analyzed_data_file= '/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/hardware/SH0015/lowOcc/Run000002_NoiseScan.root'; 
# Path to the .txt file that contains sensor information
analyzed_txt_file ='/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/hardware/SH0015/lowOcc/CMSIT_RD53_SH0015_0_12_OUT.txt'# Thresholds and other parameters
