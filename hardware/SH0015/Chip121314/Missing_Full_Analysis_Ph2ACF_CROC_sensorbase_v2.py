...
parser.add_argument('-outpath','--outpath', help = 'The name of the folder to be created in results', default = 'SH0015_Tunedto2000_Chip12', type = str)
parser.add_argument('-sensor','--sensor', help = 'The name of the sensor', default = 'SH0015_Tunedto2000_Chip12', type = str)
...
Sensor=args.sensor; 
thr_data_file='/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/hardware/SH0015/Chip121314/Run000031_SCurve.root'
# Path where the results will be stored
Path='results_xray/'
# Path to the NoiseScan root file (PixelAlive for us)
analyzed_data_file= '/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/hardware/SH0015/Chip121314/Run000000_NoiseScan.root'; 
# Path to the .txt file that contains sensor information
analyzed_txt_file ='/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/hardware/SH0015/Chip121314/CMSIT_RD53_SH0015_0_12_OUT.txt'# Thresholds and other parameters
