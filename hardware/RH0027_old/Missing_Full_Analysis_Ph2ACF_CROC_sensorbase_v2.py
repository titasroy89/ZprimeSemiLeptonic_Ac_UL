...
Sensor=args.sensor; thr_data_file='/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/hardware/RH0027/Run000021_SCurve.root'
# Path where the results will be stored
Path='results_xray/'
# Path to the NoiseScan root file (PixelAlive for us)
analyzed_data_file='/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/hardware/RH0027/Run000000_NoiseScan.root'; 
# Path to the .txt file that contains sensor information
analyzed_txt_file ='/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/hardware/RH0027/CMSIT_RD53_RH0027_0_12_OUT.txt'
