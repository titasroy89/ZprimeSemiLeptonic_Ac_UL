...
mv higgs* impacts.json Ac_UL18_ele.root combine_logger.out output_combine
...
combine -M MultiDimFit --algo singles -d $WORKSPACE -v $VERBOSITY --redefineSignalPOIs $redefineSignalPOIs --setParameterRanges $SetParameterRanges --setParameters $SetParameters --robustFit 1 --cminDefaultMinimizerStrategy 0 -m 125 --saveWorkspace -n _paramFit_Test_allStatsFrozen --freezeParameters prop_binele_UL18_SR_bin0_Others,prop_binele_UL18_SR_bin0_ST,prop_binele_UL18_SR_bin0_TTbar_1,prop_binele_UL18_SR_bin0_TTbar_2,prop_binele_UL18_SR_bin1_Others,prop_binele_UL18_SR_bin1_ST,prop_binele_UL18_SR_bin1_TTbar_1,prop_binele_UL18_SR_bin1_TTbar_2 $ASIMOV
