            ...
            if sample == "TTbar":
                ...
                if not Matrix:
                    ...
                    if "JER_up" in sys_variation or "JER_down" in sys_variation:
                        output_name_1 = "TTbar_1_{}_{}".format(sys_variation.split('_')[0].lower(), "UL16" + sys_variation.split('_')[1].capitalize())
                        output_name_2 = "TTbar_2_{}_{}".format(sys_variation.split('_')[0].lower(), "UL16" + sys_variation.split('_')[1].capitalize())
