...

{
   ...
   reco-> Add("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_combine/UL18/electron/workdir_Analysis_UL18_electron_data/DATA.root");
    ...
    TFile *file = TFile::Open("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_combine/UL18/electron/workdir_Analysis_UL18_electron_data/DATA.root"); 
    TH1D *h_DeltaY_reco = (TH1D*) file->Get("DeltaY_reco_750_900_ele_General/DeltaY_reco");
  ...
  // --------------- Output File ------------------
    ...
    TFile* myFile = new TFile("dY_UL18_ele_750_900_DATA.root", "RECREATE");
