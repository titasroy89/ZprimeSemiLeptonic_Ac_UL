...
for sample in stackList:
    ...
    if sample == "DATA":
        ...
        h_PP = inFile.Get("DY_P_P_750_1000_muon_General/DeltaY").Clone()
        h_PN = inFile.Get("DY_P_N_750_1000_muon_General/DeltaY").Clone()
        h_NP = inFile.Get("DY_N_P_750_1000_muon_General/DeltaY").Clone()
        h_NN = inFile.Get("DY_N_N_750_1000_muon_General/DeltaY").Clone()
    ...
    for sys_variation in sys_variations: 
        for sample in v_samples:
            ...
            if sample == "TTbar":
                ...
                for quadrant in ["P_P", "P_N", "N_P", "N_N"]:
                    hist_name = "DY_{}_750_1000_muon_General/DeltaY_reco".format(quadrant)
                ...
                hist_name = "DeltaY_reco_750_1000_muon_General/DeltaY_reco"
