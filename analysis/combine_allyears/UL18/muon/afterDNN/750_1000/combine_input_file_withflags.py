    ...
    for sample in v_samples:
        ...
        if sample == "Diboson":
            ...
            for i in range(1, 101):
                ...
                h_PP_pdf = inFile.Get("DeltaY_reco_PDFVariations_P_P_{}_{}/DeltaY_PDF_{}".format(mass_range, lepton_flavor, i)).Clone()
                h_PN_pdf = inFile.Get("DeltaY_reco_PDFVariations_P_N_{}_{}/DeltaY_PDF_{}".format(mass_range, lepton_flavor, i)).Clone()
                h_NP_pdf = inFile.Get("DeltaY_reco_PDFVariations_N_P_{}_{}/DeltaY_PDF_{}".format(mass_range, lepton_flavor, i)).Clone()
                h_NN_pdf = inFile.Get("DeltaY_reco_PDFVariations_N_N_{}_{}/DeltaY_PDF_{}".format(mass_range, lepton_flavor, i)).Clone()
            ...
            hist_pdfUp_1 = TH1F("TTbar_1_pdfUp", "", projection_1_nominal.GetNbinsX(), projection_1_nominal.GetXaxis().GetXmin(), projection_1_nominal.GetXaxis().GetXmax())
            hist_pdfDown_1 = TH1F("TTbar_1_pdfDown", "", projection_1_nominal.GetNbinsX(), projection_1_nominal.GetXaxis().GetXmin(), projection_1_nominal.GetXaxis().GetXmax())
            hist_pdfUp_2 = TH1F("TTbar_2_pdfUp", "", projection_2_nominal.GetNbinsX(), projection_2_nominal.GetXaxis().GetXmin(), projection_2_nominal.GetXaxis().GetXmax())
            hist_pdfDown_2 = TH1F("TTbar_2_pdfDown", "", projection_2_nominal.GetNbinsX(), projection_2_nominal.GetXaxis().GetXmin(), projection_2_nominal.GetXaxis().GetXmax())
