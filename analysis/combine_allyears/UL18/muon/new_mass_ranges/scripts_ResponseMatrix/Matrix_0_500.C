...
void Matrix_0_500() {
    ...
    std::vector<std::string> inputFiles = {"Semi1.root", "OtherTT.root"};

    std::map<std::string, std::string> histNames = {
        {"DY_N_N_Mass_0_500_reco_muon_General/DeltaY_muon", "h_DeltaY_N_N"}, 
        {"DY_N_P_Mass_0_500_reco_muon_General/DeltaY_muon", "h_DeltaY_N_P"}, 
        {"DY_P_N_Mass_0_500_reco_muon_General/DeltaY_muon", "h_DeltaY_P_N"}, 
        {"DY_P_P_Mass_0_500_reco_muon_General/DeltaY_muon", "h_DeltaY_P_P"}
        };
    ...
    TFile* outFile = new TFile("0_500.root", "RECREATE");
    ...
    TFile* openOutFile = new TFile("0_500.root", "READ");
    ...
    TFile* outFileWrite = new TFile("0_500.root", "UPDATE");
    outFileWrite->cd();  
    Matrix->Write();
    outFileWrite->Close();
