...
parser.add_option("-m", "--mass_range", dest="mass_range", help="Specify the mass range (0_500, 500_750, 750-1000, 1000_1500, 1500Inf)", type='str')
...
for sample in stackList:
    ...
    if sample == "DATA":
        ...
        print("Processing sample for other sys: ", sample)
        path_nom = "DeltaY_reco_SystVariations_ttbar_{}_{}_CR1/DeltaY_tt".format(mass_range, lepton_flavor)
        ...
        for sys, new_sys_name in systematic_name_mapping.items():
            ...
            for variation in ["up", "down"]:
                ...
                matrix_path = "DeltaY_reco_SystVariations_ttbar_{}_{}_CR1/DeltaY_{}_{}_tt".format(mass_range, lepton_flavor, sys,variation)
...
def getEnvelope(inputDir, v_samples, v_variations, combine_file):
    ...
    for sample in v_samples:
        ...
        if sample == "TTbar":
            ...
            # pdf_nominal_path = "DeltaY_reco_SystVariations_{}_{}_CR1/DeltaY".format(mass_range, lepton_flavor)
...
def processPDF(inputDir, v_samples, combine_file):
    ...
    for sample in v_samples:
        ...
        if sample == "Diboson":
                nominal_hist_name = "DeltaY_reco_{}_{}_CR1_General/DeltaY_reco".format(mass_range, lepton_flavor)
            ...
            # nom_mat_path = "DY_ttbar_{}_{}_CR1_General/response_matrix".format(mass_range, lepton_flavor)
            ...
            for i in range(1, 101):  
                weight_matrix_path = "DeltaY_reco_PDFVariations_ttbar_{}_{}_CR1/DeltaY_PDF_RM_{}".format(mass_range, lepton_flavor, i)
    ...
    for sys_variation in sys_variations: 
        ...
        for sample in v_samples:
            ...
            if sample == "TTbar":
                ...
                matrix_path_jerjec = "DY_ttbar_{}_{}_CR1_General/response_matrix".format(mass_range, lepton_flavor)
                ...
                hist_name = "DeltaY_reco_{}_{}_CR1_General/DeltaY_reco".format(mass_range, lepton_flavor)
