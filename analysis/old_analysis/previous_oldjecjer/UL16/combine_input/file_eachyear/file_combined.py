...
year = options.year if options.year else "UL16"  
...
def copy_histograms(input_files, output_file_path):
    ...
    directories = {
        '../individual_files/dY_UL16_{}_{}_CR1.root'.format(lepton_flavor, mass_range) : 'CR1',
        '../individual_files/dY_UL16_{}_{}_CR2.root'.format(lepton_flavor, mass_range): 'CR2',
        '../individual_files/dY_UL16_{}_{}_SR.root'.format(lepton_flavor, mass_range) : 'SR'
    }
...
output_file_path = 'dY_UL16_{}_{}.root'.format(lepton_flavor, mass_range)
