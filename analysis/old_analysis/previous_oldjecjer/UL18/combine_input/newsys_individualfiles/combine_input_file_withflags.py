...
inputDir = "/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_DNN/{}/{}/titas_new_samples/".format(year, lepton_flavor)
...
stackList = ["TTbar", "ST", "WJets", "Diboson", "QCD", "DYJets", "DATA"]
...
def processJERJEC(inputDir, v_samples_ttbar, combine_file, sys_variations):
    ...
    for sys_variation in sys_variations: 
        ...
        for sample in v_samples_ttbar:
            sys_file = TFile.Open("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_DNN/{}/{}/workdir_AnalysisDNN_{}_{}_{}_doublecheck/{}.root".format(year, lepton_flavor, year, lepton_flavor, sys_variation, sample), "READ")
            if not sys_file:
