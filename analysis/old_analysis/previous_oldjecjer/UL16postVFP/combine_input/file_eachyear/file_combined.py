...
parser = OptionParser()
parser.add_option("-y", "--year", dest="year", help="Specify the year (UL16postVFP, UL17, preUL16, postUL16)", type='str')
...
year = options.year if options.year else "UL16postVFP"  
...
def copy_histograms(input_files, output_file_path):
    ...
    directories = {
        '../individual_files/dY_UL16postVFP_{}_{}_CR1.root'.format(lepton_flavor, mass_range) : 'CR1',
        '../individual_files/dY_UL16postVFP_{}_{}_CR2.root'.format(lepton_flavor, mass_range): 'CR2',
        '../individual_files/dY_UL16postVFP_{}_{}_SR.root'.format(lepton_flavor, mass_range) : 'SR'
    }
...
output_file_path = 'dY_UL16postVFP_{}_{}.root'.format(lepton_flavor, mass_range)
