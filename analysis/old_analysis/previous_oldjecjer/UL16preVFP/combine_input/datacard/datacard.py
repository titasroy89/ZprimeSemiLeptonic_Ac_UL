...
----------------------------------------------------------------------------------------------------------------------------------
shapes data_obs     {lepton}_{year}_{mass_range}_SR      /nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/analysis/newmatching/UL16preVFP/combine_input/individual_files/dY_{year}_{lepton}_{mass_range}_SR.root data_obs
shapes *            {lepton}_{year}_{mass_range}_SR      /nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/analysis/newmatching/UL16preVFP/combine_input/individual_files/dY_{year}_{lepton}_{mass_range}_SR.root $PROCESS $PROCESS_$SYSTEMATIC
----------------------------------------------------------------------------------------------------------------------------------
