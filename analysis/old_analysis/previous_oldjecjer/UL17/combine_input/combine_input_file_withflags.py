...
def processJERJEC(inputDir, v_samples, combine_file, sys_variations):
    ...
    for sys_variation in sys_variations: 
        ...
        for sample in v_samples:
            sys_file = TFile.Open("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_DNN/UL18/{}/workdir_AnalysisDNN_{}_{}_{}_latest_dY/nominal/{}.root".format(lepton_flavor, year, lepton_flavor, sys_variation, sample), "READ")
            if not sys_file:
