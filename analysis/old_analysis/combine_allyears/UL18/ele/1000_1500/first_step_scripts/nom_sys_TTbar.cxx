...

{
    ...
    TH1D *h_DeltaY_P_P_250_500_muon = new TH1D("DeltaY_P_P_250_500_muon","0<Mtt<250, #Delta_Y_{gen} > 0, #Delta_Y_{reco} > 0 ",1,0,2.5);
    // POSITIVE gen, NEGATIVE reco, with mass cut
    TH1D *h_DeltaY_P_N_250_500_muon = new TH1D("DeltaY_P_N_250_500_muon","0<Mtt<250, #Delta_Y_{gen} > 0, #Delta_Y_{reco} < 0",1,-2.5,0);
    // NEGATIVE gen, POSITIVE reco, with mass cut
    TH1D *h_DeltaY_N_P_250_500_muon = new TH1D("h_DeltaY_N_P_250_500_muon","0<Mtt<250, #Delta_Y_{gen} < 0, #Delta_Y_{reco} > 0",1,0,2.5);
    // NEAGATIVE gen, NEGATIVE reco, without mass cut
    TH1D *h_DeltaY_N_N_250_500_muon = new TH1D("h_DeltaY_N_N_250_500_muon","0<Mtt<250, #Delta_Y_{gen} < 0, #Delta_Y_{reco} < 0",1,-2.5,0);
 ...
 //Btagging Discriminator
    ...
    float DeltaY_P_P_250_500_muon;
    float DeltaY_P_N_250_500_muon;
    float DeltaY_N_P_250_500_muon;
    float DeltaY_N_N_250_500_muon;
    ...
    treereco->SetBranchAddress("DeltaY_P_P_250_500_muon",&DeltaY_P_P_250_500_muon);
    treereco->SetBranchAddress("DeltaY_P_N_250_500_muon",&DeltaY_P_N_250_500_muon);
    treereco->SetBranchAddress("DeltaY_N_P_250_500_muon",&DeltaY_N_P_250_500_muon);
    treereco->SetBranchAddress("DeltaY_N_N_250_500_muon",&DeltaY_N_N_250_500_muon);
    ...
    // for (Int_t i = 0; i < 10000; i++){
       ...
       h_DeltaY_P_P_250_500_muon->Fill(DeltaY_P_P_250_500_muon);
       h_DeltaY_P_N_250_500_muon->Fill(DeltaY_P_N_250_500_muon);
       h_DeltaY_N_P_250_500_muon->Fill(DeltaY_N_P_250_500_muon);
       h_DeltaY_N_N_250_500_muon->Fill(DeltaY_N_N_250_500_muon);
    ...
    double integral [2][2] = {{h_DeltaY_N_N_250_500_muon->Integral(),h_DeltaY_P_N_250_500_muon->Integral()},{h_DeltaY_N_P_250_500_muon->Integral(),h_DeltaY_P_P_250_500_muon->Integral()}};
  ...
  // --------------- Output File ------------------
    ...
    TFile* myFile = new TFile("dY_UL18_muon_250_500_TTbar.root", "RECREATE");
 

    h_DeltaY_P_P_250_500_muon->Write();
    h_DeltaY_P_N_250_500_muon->Write();
    h_DeltaY_N_P_250_500_muon->Write();
    h_DeltaY_N_N_250_500_muon->Write();
