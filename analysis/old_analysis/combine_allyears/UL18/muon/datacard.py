def create_datacard(year, mass_range, lepton_flavor):
    ...
    filepath = './dY_{}_{}_{}.root'.format(year, lepton_flavor, mass_range)
    ...
    with open(filename, 'w') as file:
        ...
        electron_systematics = [
            ...
            "isr                 shape   1         1         -         -         -         -         -",
            "fsr                 shape   1         1         -         -         -         -         -",
            "btagCferr1          shape   1         1         1         1         1         -         1",
            "btagCferr2          shape   1         1         1         1         1         -         1",
            "btagHf              shape   1         1         1         1         1         -         1",
            "btagHfstats1        shape   1         1         1         1         1         -         1",
            "btagHfstats2        shape   1         1         1         1         1         -         1",
            "btagLf              shape   1         1         1         1         1         -         1",
            "btagLfstats1        shape   1         1         1         1         1         -         1",
            "btagLfstats2        shape   1         1         1         1         1         -         1",
            "ttagCorr            shape   1         1         1         1         1         -         1",
            "ttagUncorr          shape   1         1         1         1         1         -         1",
            "tmistag             shape   1         1         1         1         1         -         1",
            "murmuf              shape   1         1         -         -         -         -         -",
            "pdf                 shape   1         1         -         -         -         -         -",
            "jer                 shape   1         1         -         -         -         -         -",
            "jec                 shape   1         1         -         -         -         -         -",
        ...
        muon_systematics = [
            ...
            "{}_{}_{} autoMCStats 1e06 1 1".format(lepton_flavor, year, mass_range)
...
years = ["UL18"]
mass_ranges = ["0_500", "500_750", "1000_1500", "1500Inf"]
