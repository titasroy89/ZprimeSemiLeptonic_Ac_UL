...
void Matrix_250_500() {
    ...
    std::map<std::string, std::string> histNames = {
        {"DY_N_N_Mass_250_500_reco_muon_General/DeltaY_muon", "h_DeltaY_N_N"}, 
        {"DY_N_P_Mass_250_500_reco_muon_General/DeltaY_muon", "h_DeltaY_N_P"}, 
        {"DY_P_N_Mass_250_500_reco_muon_General/DeltaY_muon", "h_DeltaY_P_N"}, 
        {"DY_P_P_Mass_250_500_reco_muon_General/DeltaY_muon", "h_DeltaY_P_P"}
        };
