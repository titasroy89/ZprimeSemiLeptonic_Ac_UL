...

{
    ...
    reco-> Add("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_combine/UL18/muon/workdir_Analysis_UL18_muon_new_massranges/nominal/Semi1.root");
    reco-> Add("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_combine/UL18/muon/workdir_Analysis_UL18_muon_new_massranges/nominal/TTbar.root");
    ...
    TH1D *h_DeltaY_P_P_1000_1500_muon = new TH1D("DeltaY_P_P_1000_1500_muon","0<Mtt<250, #Delta_Y_{gen} > 0, #Delta_Y_{reco} > 0 ",1,0,2.5);
    // POSITIVE gen, NEGATIVE reco, with mass cut
    TH1D *h_DeltaY_P_N_1000_1500_muon = new TH1D("DeltaY_P_N_1000_1500_muon","0<Mtt<250, #Delta_Y_{gen} > 0, #Delta_Y_{reco} < 0",1,-2.5,0);
    // NEGATIVE gen, POSITIVE reco, with mass cut
    TH1D *h_DeltaY_N_P_1000_1500_muon = new TH1D("h_DeltaY_N_P_1000_1500_muon","0<Mtt<250, #Delta_Y_{gen} < 0, #Delta_Y_{reco} > 0",1,0,2.5);
    // NEAGATIVE gen, NEGATIVE reco, without mass cut
    TH1D *h_DeltaY_N_N_1000_1500_muon = new TH1D("h_DeltaY_N_N_1000_1500_muon","0<Mtt<250, #Delta_Y_{gen} < 0, #Delta_Y_{reco} < 0",1,-2.5,0);
 ...
 //Btagging Discriminator
    ...
    float DeltaY_P_P_1000_1500_muon;
    float DeltaY_P_N_1000_1500_muon;
    float DeltaY_N_P_1000_1500_muon;
    float DeltaY_N_N_1000_1500_muon;
    ...
    treereco->SetBranchAddress("DeltaY_P_P_1000_1500_muon",&DeltaY_P_P_1000_1500_muon);
    treereco->SetBranchAddress("DeltaY_P_N_1000_1500_muon",&DeltaY_P_N_1000_1500_muon);
    treereco->SetBranchAddress("DeltaY_N_P_1000_1500_muon",&DeltaY_N_P_1000_1500_muon);
    treereco->SetBranchAddress("DeltaY_N_N_1000_1500_muon",&DeltaY_N_N_1000_1500_muon);
    ...
    // for (Int_t i = 0; i < 10000; i++){
       ...
       h_DeltaY_P_P_1000_1500_muon->Fill(DeltaY_P_P_1000_1500_muon);
       h_DeltaY_P_N_1000_1500_muon->Fill(DeltaY_P_N_1000_1500_muon);
       h_DeltaY_N_P_1000_1500_muon->Fill(DeltaY_N_P_1000_1500_muon);
       h_DeltaY_N_N_1000_1500_muon->Fill(DeltaY_N_N_1000_1500_muon);
    ...
    double integral [2][2] = {{h_DeltaY_N_N_1000_1500_muon->Integral(),h_DeltaY_P_N_1000_1500_muon->Integral()},{h_DeltaY_N_P_1000_1500_muon->Integral(),h_DeltaY_P_P_1000_1500_muon->Integral()}};
  ...
  // --------------- Output File ------------------
    ...
    TFile* myFile = new TFile("dY_UL18_muon_1000_1500_TTbar.root", "RECREATE");
 

    h_DeltaY_P_P_1000_1500_muon->Write();
    h_DeltaY_P_N_1000_1500_muon->Write();
    h_DeltaY_N_P_1000_1500_muon->Write();
    h_DeltaY_N_N_1000_1500_muon->Write();
...
void mergeRootFiles() {
    TFile *inputFile1 = TFile::Open("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_combine/UL18/muon/workdir_Analysis_UL18_muon_new_massranges/nominal/Semi1.root", "READ");   
    TFile *inputFile2 = TFile::Open("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_combine/UL18/muon/workdir_Analysis_UL18_muon_new_massranges/nominal/TTbar.root", "READ");

    TFile *outputFile = TFile::Open("dY_UL18_muon_1000_1500_TTbar.root", "RECREATE");
