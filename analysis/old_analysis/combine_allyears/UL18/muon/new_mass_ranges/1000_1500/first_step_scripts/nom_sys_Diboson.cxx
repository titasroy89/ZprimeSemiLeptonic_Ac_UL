...

{
    ...
    reco-> Add("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_combine/UL18/muon/workdir_Analysis_UL18_muon_new_massranges/nominal/Diboson.root");
    ...
    TFile *file = TFile::Open("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_combine/UL18/muon/workdir_Analysis_UL18_muon_new_massranges/nominal/Diboson.root"); 
    TH1D *h_DeltaY_reco = (TH1D*) file->Get("DeltaY_reco_0_500_muon_General/DeltaY_reco");
  ...
  // --------------- Output File ------------------
    ...
    TFile* myFile = new TFile("dY_UL18_muon_0_500_Diboson.root", "RECREATE");
    ...
    //     }
    // } else {
    //     std::cerr << "No keys found in root file!" << std::endl;
    // }
