...

{
    ...
    reco-> Add("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_combine/UL18/muon/workdir_Analysis_UL18_muon_new_massranges/nominal/WJets.root");
    ...
    TFile *file = TFile::Open("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_combine/UL18/muon/workdir_Analysis_UL18_muon_new_massranges/nominal/WJets.root"); 
 ...
 //Btagging Discriminator
  ...
  // --------------- Output File ------------------
    ...
    TFile* myFile = new TFile("dY_UL18_muon_0_500_WJets.root", "RECREATE");
