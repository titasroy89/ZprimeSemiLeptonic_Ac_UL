...
# file = ROOT.TFile.Open('/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/EFTvsUL/output_EFT/Preselection/workdir_EFT_preselection_HT800_finalversion_moreplots/uhh2.AnalysisModuleRunner.MC.EFT_sample_UL18_0.root', 'READ')
file = ROOT.TFile.Open("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/EFTvsUL/output_UL/Preselection/workdir_Preselection_UL18_powheg_HT800_finalversion_moreplots/TTbar.root", 'READ')
