...
path_data=/nfs/dust/cms/group/zprime-uhh/Presel_UL18_hdamp_down/workdir_Preselection_UL18_hdamp_down/uhh2.AnalysisModuleRunner.

mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_UL18_preselection_hdamp_down
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_UL18_preselection_hdamp_down
