...
mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_UL18_EFT_samples_morefiles
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_UL18_EFT_samples_morefiles
...
do
    echo $sample_name
       ...
       $pathGL_code/scripts/create-dataset-xmlfile ${path_data}"EFT*.root" $sample_name.xml
