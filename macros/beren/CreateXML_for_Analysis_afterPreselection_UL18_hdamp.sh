...
path_data=/data/dust/group/cms/zprime-uhh/hdamp/Preselection/UL18/workdir_Preselection_UL18_hdamp_up/uhh2.AnalysisModuleRunner.

mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_Analysis_afterPreselection_UL18_hdamp_up
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_Analysis_afterPreselection_UL18_hdamp_up
