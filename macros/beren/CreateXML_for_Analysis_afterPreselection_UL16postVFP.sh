...
path_data=/data/dust/group/cms/zprime-uhh/Presel_UL16postVFP_templatemethod/workdir_Preselection_UL16postVFP_templatemethod/uhh2.AnalysisModuleRunner.

mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_Analysis_afterPreselection_UL16postVFP_templatemethod
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_Analysis_afterPreselection_UL16postVFP_templatemethod
