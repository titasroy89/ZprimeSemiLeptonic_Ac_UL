...
path_data=/data/dust/group/cms/zprime-uhh/hdamp/Analysis/UL18/electron/workdir_Analysis_UL18_electron_hdamp_up/uhh2.AnalysisModuleRunner.

mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_DNN_UL18_electron_hdamp_up
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_DNN_UL18_electron_hdamp_up
