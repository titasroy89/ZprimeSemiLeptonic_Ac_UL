...
path_data="/pnfs/desy.de/cms/tier2//store/group/uhh/uhh2ntuples/RunII_106X_v2/UL17/TTJets_TuneCP5_13TeV-amcatnloFXFX-pythia8/crab_TTJets_CP5_amcatnloFXFX-pythia8_Summer20UL17_v2/251207_023549"

# Define the output directory
output_dir="$pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_Madgraph_UL17_Preselection"

# Create the output directory if it doesn't exist
mkdir -p "$output_dir"
cd "$output_dir" || { echo "Failed to enter directory: $output_dir"; exit 1; }

samples=("TTJets_Madgraph_UL17")
