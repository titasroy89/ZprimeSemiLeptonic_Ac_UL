...
path_data=/data/dust/group/cms/zprime-uhh/hdamp/Preselection/UL17/workdir_Preselection_UL17_hdamp_down/uhh2.AnalysisModuleRunner.

mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_Analysis_afterPreselection_UL17_hdamp_down
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_Analysis_afterPreselection_UL17_hdamp_down
