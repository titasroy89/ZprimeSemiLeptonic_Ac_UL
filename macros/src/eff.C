...
void eff(){
  ...
  for(unsigned int i=0; i<samples.size(); i++){
    ...
    float n_before           = ((TH1F*)(f_in->Get("MET_General/N_mu")))->Integral();
    float n_before_matchable = ((TH1F*)(f_in->Get("MatchableBeforeChi2Cut_General/N_mu")))->Integral();
    float n_before_correct   = ((TH1F*)(f_in->Get("CorrectMatchBeforeChi2Cut_General/N_mu")))->Integral();
    float n_after           = ((TH1F*)(f_in->Get("Chi2_General/N_mu")))->Integral();
    float n_after_matchable = ((TH1F*)(f_in->Get("Matchable_General/N_mu")))->Integral();
    float n_after_correct   = ((TH1F*)(f_in->Get("CorrectMatch_General/N_mu")))->Integral();
    ...
    cout << "size " << before_matchable[0] << endl;
...
/*
  ...
  TString outname = "Plots/ReconstructionQuality_Matchable";
  ...
  outname = "Plots/ReconstructionQuality_CorrectlyMatched";
