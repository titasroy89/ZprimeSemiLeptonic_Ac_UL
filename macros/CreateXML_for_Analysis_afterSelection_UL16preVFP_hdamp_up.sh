...
path_data=/nfs/dust/cms/group/zprime-uhh/Analysis_UL16preVFP/hdamp_up/electron/workdir_Analysis_UL16preVFP_electron_hdamp_up/uhh2.AnalysisModuleRunner.

mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_UL16preVFP_electron_hdamp_up
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_UL16preVFP_electron_hdamp_up
