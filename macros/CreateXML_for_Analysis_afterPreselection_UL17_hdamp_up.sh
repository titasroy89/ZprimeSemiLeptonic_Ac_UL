...
path_data=/nfs/dust/cms/group/zprime-uhh/Presel_UL17_hdamp_up/workdir_Preselection_UL17_hdamp_up/uhh2.AnalysisModuleRunner.

mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_UL17_preselection_hdamp_up
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_UL17_preselection_hdamp_up
