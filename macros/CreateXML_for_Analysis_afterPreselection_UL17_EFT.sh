...
path_data=/data/dust/group/cms/zprime-uhh/Preselection_EFT_UL17/workdir_Preselection_EFT_UL17_dilepton/uhh2.AnalysisModuleRunner.

mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_EFT_UL17_afterpreselection_dilepton
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_EFT_UL17_afterpreselection_dilepton
