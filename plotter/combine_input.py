...
for key, var in _REGIONS.items():
    ...
    # SM processes
    processes_Plotter = [
        Process(hist_name + region + '_TTToSemiLeptonic', 't#bar{t}', root.kRed, 1., 0.2),
        Process(hist_name + region + '_TTToOthers', 't#bar{t}', root.kPink-3, 1., 0.2),
    ...
    signals_Plotter = [
        ...
        Process(hist_name + region + '_TTToSemiLeptonic', 't#bar{t} Semileptonic', root.kRed),
        Process(hist_name + region + '_TTToOthers', 't#bar{t} Others', root.kPink-3, 1),
    ]
