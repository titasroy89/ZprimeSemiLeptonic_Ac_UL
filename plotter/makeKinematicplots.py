...
histograms={"M_Zprime":["M_{t#bar{t}} [GeV]", "Events", 280, [0, 6000]],
...
test_sample = ( 'TTbar', 'WJets', 'DYJets', 'Diboson','QCD','ST')
...
for hist in histograms:
	if "DeltaY" in hist: 
		...
		for cat in categories:
			...
			stack.GetXaxis().SetTitle("\Delta Y")
			stack.GetYaxis().SetMaxDigits(7)
			stack.Draw("HIST")
