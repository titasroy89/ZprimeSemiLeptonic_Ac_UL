...
// 	TCanvas *c1 = (TCanvas*)file.Get("OSU1200_12");
// 	TGraphAsymmErrors *ae = (TGraphAsymmErrors*)c1->GetPrimitive("OSU1200_12");
...
//    TCanvas *c1 = (TCanvas*)f.Get("OSU1200_12");
//    TGraphAsymmErrors *ae = (TGraphAsymmErrors*)c1->GetPrimitive("OSU1200_12");

//    TCanvas *c2 = (TCanvas*)f.Get("UIC1200_12");
//    TH1D *h1 = nullptr;
...
//       h1->Draw();
//       ae->Draw("L");
// 	  h1 ->Write("OSU1200_12_2");
// 	  ae->Write("UIC1200_12_2");
//    }

const char* h_1="OSU800_12";
const char* h_2="UIC800_12";
const char* h_3="Cor800_12";

const char* n_1="OSU 800e";
const char* n_2="UIC 800e";
const char* n_3="Cornell 800e";

TFile *file = TFile::Open("General3.root");
