...
class ZprimeAnalysisModule_data : public ModuleBASE {

public:

  explicit ZprimeAnalysisModule_data(uhh2::Context&);
...
void ZprimeAnalysisModule_data::book_histograms(uhh2::Context& ctx, vector<string> tags){
...
void ZprimeAnalysisModule_data::fill_histograms(uhh2::Event& event, string tag){
  string mytag = tag + "_Skimming";
  mytag = tag + "_General";
...
ZprimeAnalysisModule_data::ZprimeAnalysisModule_data(uhh2::Context& ctx){
...
bool ZprimeAnalysisModule_data::process(uhh2::Event& event){
...
// select ttbar candidate with smallest chi2, fill Mtt hists
  ...
  ////DeltaY lines start here
    ...
    if(debug) cout << "deltaY 2" << endl;
    event.set(h_DeltaY_reco,DeltaY_reco);
    if(debug) cout << "deltaY 3" << endl;
...
UHH2_REGISTER_ANALYSIS_MODULE(ZprimeAnalysisModule_data)
