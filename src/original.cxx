...
//   //-beren -generator
//   Chi_2              = book<TH1F>("Chi_2", "Chi_2", 100, 0, 300);
...
//   M_tt_weighted    = book<TH1F>("M_tt_weighted", "M_tt_weighted", 100, 0, 14000);
//   M_tt_notweighted = book<TH1F>("M_tt_notweighted", "M_tt_notweighted", 100, 0, 14000);
...
//     if(is_mc) M_tt_weighted->Fill(Mass_tt,weight);
//     if(is_mc) M_tt_notweighted->Fill(Mass_tt);
//     Chi_2->Fill(chi2,weight);
//   }
