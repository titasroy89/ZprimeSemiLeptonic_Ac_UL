...
class ZprimeAnalysisModule_dY : public ModuleBASE {

public:

  explicit ZprimeAnalysisModule_dY(uhh2::Context&);
...
void ZprimeAnalysisModule_dY::book_histograms(uhh2::Context& ctx, vector<string> tags){
...
void ZprimeAnalysisModule_dY::fill_histograms(uhh2::Event& event, string tag){
  string mytag = tag + "_Skimming";
  mytag = tag + "_General";
...
ZprimeAnalysisModule_dY::ZprimeAnalysisModule_dY(uhh2::Context& ctx){
  ...
  vector<string> histogram_tags = { "Initial", "Middle", "Last",
...
bool ZprimeAnalysisModule_dY::process(uhh2::Event& event){
...
// select ttbar candidate with smallest chi2, fill Mtt hists
  ...
  fill_histograms(event, "Last");
  
  return true;
}

UHH2_REGISTER_ANALYSIS_MODULE(ZprimeAnalysisModule_dY)
