...
ZprimeSemiLeptonicSystematicsModule::ZprimeSemiLeptonicSystematicsModule(Context& ctx){
  ...
  v_systs = {"pu", "prefiring", "mu_id", "mu_iso", "mu_reco", "mu_trigger", "ele_id", "ele_reco", "ele_trigger", "ttag_corr", "ttag_uncorr"};
  v_syst_handlenames = {"weight_pu", "prefiringWeight", "weight_sfmu_id", "weight_sfmu_iso", "weight_sfmu_reco", "weight_sfmu_trigger", "weight_sfelec_id", "weight_sfelec_reco", "weight_sfelec_trigger", "weight_toptagsf_corr", "weight_toptagsf_uncorr"};
