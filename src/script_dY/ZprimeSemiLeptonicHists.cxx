...
void ZprimeSemiLeptonicHists::fill(const Event & event){
  ...
  */
  ...
  if(is_zprime_reconstructed_chi2){
    ...
    if(Mreco>=0 && Mreco < 500){
        DeltaY_reco_0_500->Fill(dyreco, weight);
      }
    if(Mreco >= 500 && Mreco < 750){
        DeltaY_reco_500_750->Fill(dyreco, weight);
      }
    if(Mreco >= 750 && Mreco < 1000){
        DeltaY_reco_750_1000->Fill(dyreco, weight);
      }
    if(Mreco >= 1000 && Mreco < 1500){
        DeltaY_reco_1000_1500->Fill(dyreco, weight);
      }
    if(Mreco > 1500){
        DeltaY_reco_1500Inf->Fill(dyreco, weight);
      }
  }
