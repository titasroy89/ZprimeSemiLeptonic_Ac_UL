...
ZprimeAnalysisModule::ZprimeAnalysisModule(uhh2::Context& ctx){
  ...
  if(isMC){
    ...
    if( (ctx.get("dataset_version").find("MC_EFT_Mttbar_0-700_UL17") != std::string::npos) || (ctx.get("dataset_version").find("MC_EFT_Mttbar_700-900_UL17") != std::string::npos) || (ctx.get("dataset_version").find("MC_EFT_Mttbar_900-Inf_UL17") != std::string::npos) ) sample_name = "TTbar_EFT";
